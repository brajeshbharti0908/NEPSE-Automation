...
protected WebDriver driver;
	...
	protected void waitAndMoveToElement(final WebElement element) {
		waitAndMoveToElement(element);
		moveToElement(element);
	}

	protected void waitAndMoveToElement(final By by) {
		waitAndMoveToElement(by);
		moveToElement(by);
	}
	...
	public void switchWindow(final String url) throws InterruptedException {
		Thread.sleep(2000);
	...
	protected void highlightElement(final WebElement element) throws InterruptedException {
